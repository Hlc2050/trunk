(function (e, $) {
    ...
    var fb = {
        ...
        gb = [{n: "p", t: "\u666e\u901a\u6bb5\u843d"}, {n: "h1", t: "\u6807\u98981"}, {
            ...
            n: "\u5fae\u8f6f\u96c5\u9ed1",
            c: "Microsoft YaHei"
        },{n: "\u5b8b\u4f53", c: "SimSun"}, {n: "\u4eff\u5b8b\u4f53", c: "FangSong_GB2312"}, {
            n: "\u9ed1\u4f53",
            c: "SimHei"
        }, {n: "\u6977\u4f53", c: "KaiTi_GB2312"},  {n: "Arial"}, {n: "Arial Black"},
            {n: "Comic Sans MS"}, {n: "Courier New"}, {n: "System"}, {n: "Times New Roman"}, {n: "Tahoma"}, {n: "Verdana"}],
        T = [{n: "normal", s: "15px", t: "\u6807\u51c6"}, {n: "small", s: "12px", t: "\u7279\u5c0f"}, {n: "small2", s: "14px", t: "\u5c0f"}, {
            n: "medium",
            s: "16px",
            t: "\u5c0f"
            ...
            s: "\u5de6\u5bf9\u9f50",
            v: "justifyleft"
        }, {s: "\u5c45\u4e2d", v: "justifycenter"}, {s: "\u53f3\u5bf9\u9f50", v: "justifyright"}, {
            s: "\u4e24\u7aef\u5bf9\u9f50",
            v: "justifyfull"
        }], jb = [
            {s: "\u0031\u002c\u0032\u002c\u0033\u002e\u002e\u002e", v: "insertOrderedList"},
            {s: "\u0061\u002c\u0062\u002c\u0063\u002e\u002e\u002e", v: "insertabcList"},
            {s: "\u0041\u002c\u0042\u002c\u0043\u002e\u002e\u002e", v: "insertABCList"},
            {s: "\u0049\u002c\u0049\u0049\u002c\u0049\u0049\u0049\u002e\u002e\u002e", v: "insertURomanList"},
            {s: "\u0069\u002c\u0069\u0069\u002c\u0069\u0069\u0069\u002e\u002e\u002e", v: "insertRomanList"},
            {s: "\u25cf\u0020\u5c0f\u9ed1\u70b9", v: "insertUnorderedList"},
            {s: "\u25a0\u0020\u5c0f\u65b9\u5757\u0020", v: "insertSquareList"},
            {s: "\u25cb\u0020\u5927\u5706\u5708", v: "insertCircleList"}
        ], kb = {
            "default": {
            ...
            if (b.e)b.e.call(d); else switch (a = a.toLowerCase(), a) {
                ...
                case "fontsize":
                    ...
                    d.showMenu(q, function (a) {
                        if(a==1){
                            l.execCommand("fontSize", false, "1");
                            var fontElements = l.getElementsByTagName("font")
                            for (var i = 0, len = fontElements.length; i < len; ++i) {
                                if (fontElements[i].size == "1") {
                                    fontElements[i].removeAttribute("size");
                                    fontElements[i].style.fontSize = "15px";
                                }
                            }
                        }else {
                            d._exec("fontsize", a)
                ...
                case "list":
                    d.showMenu(jb, function (a) {
                        console.log(a);
                        if(a=='insertSquareList' || a=='insertCircleList'){
                            l.execCommand('insertOrderedList', !1, null)
                            var listElements = l.getElementsByTagName("ol")
                            console.log(listElements);
                            if(listElements.length==0){
                                l.execCommand('insertOrderedList', !1, null)
                            }
                            // listElements.style.listStyleType = "square";
                            if(a=='insertSquareList') {
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStyleType = "square";
                                        listElements[i].style.listStylePosition = "inside";
                                    }
                                }
                            }else if(a=='insertCircleList'){
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStyleType = "circle";
                                        listElements[i].style.listStylePosition = "inside";
                                    }
                                }
                            }
                        }else  if(a=='insertOrderedList' ||a=='insertURomanList' || a=='insertabcList' || a=='insertRomanList' || a=='insertABCList'){
                            l.execCommand('insertOrderedList', !1, null)
                            var listElements = l.getElementsByTagName("ol")
                            if(listElements.length==0){
                                l.execCommand('insertOrderedList', !1, null)
                            ...
                            if(a=='insertOrderedList') {
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStyleType = "decimal";
                                        listElements[i].style.listStylePosition = "inside";
                                    }

                                }
                            }else if(a=='insertabcList'){
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStyleType = "lower-latin";
                                        listElements[i].style.listStylePosition = "inside";
                                    }
                                ...
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStyleType = " upper-latin";
                                        listElements[i].style.listStylePosition = "inside";
                                    }

                                }
                            }else if(a=='insertRomanList'){
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStylePosition = "inside";
                                        listElements[i].style.listStyleType = " lower-roman";
                                    }
                                }
                            }else if(a=='insertURomanList'){
                                for (var i = 0, len = listElements.length; i < len; ++i) {
                                    if(listElements[i].style.listStyleType=='') {
                                        listElements[i].style.listStylePosition = "inside";
                                        listElements[i].style.listStyleType = " upper-roman";
                                    }
                                }
                            }
                        }else {
                            ...
                            for (var i = 0, len = listElements.length; i < len; ++i) {
                                if (listElements[i].style.listStyleType == '') {
                                    listElements[i].style.listStyleType = "disc";
                                    listElements[i].style.listStylePosition = "inside";
                                }
                            }
                        }
...
var allplugin = {
    ...
    // rowspacingtop:{
    //     c:'rowspacingtop',t:'段前距',e:function(){
    //         var _this=this;
    //         var arrMenu=[
    //             {s:'5px',v:'5px'},
    //             {s:'10px',v:'10px'},
    ...
    //             var text = _this.getSelect();
    //             var txt = text.createTextNode('p');
    //             console.log(text,txt);
    //
    //             _this._exec("paragraph",'p',{style:'margin-top:'+v});
    //             return true;
    //         });
    //     }
    // },
    // rowspacingbottom:{
    //     c:'rowspacingbottom',t:'段后距',e:function(){
    //         var _this=this;
    //         var arrMenu=[
    //             {s:'5px',v:'5px'},
    //             {s:'10px',v:'10px'},
    ...
    //         _this.showMenu(arrMenu,function(v){
    //             console.log(_this);
    //             _this._exec("paragraph",'p',{style:'margin-bottom:'+v});
    //             return true;
    //         });
    //     }
    // },
    // // rowspacingtop :{c:'rowspacingtop',t:'段前距'},
    // // rowspacingbottom :{c:'rowspacingbottom',t:'段后距'},
    //  lineheight :{c:'lineheight',t:'行间距'}
};
