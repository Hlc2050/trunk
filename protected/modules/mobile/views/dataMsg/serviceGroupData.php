...
<div class="admin-content">
    ...
    <div></div>
    <?php
    $base_url = $this->createUrl('/mobile/dataMsg/serviceGroupData').'?service_id='.$page['service_info']['id'].'&date='.$page['info']['date'];
    $user_url = $this->createUrl('/mobile/dataMsg/serviceUserData').'?service_id='.$page['service_info']['id'].'&date='.$page['info']['date'];
    ?>
        ...
        <div class="am-panel-group" id="accordion">
            <div class="am-panel am-panel-secd">
                ...
                <div class="am-panel am-panel-secondary" style="margin-bottom: 10px">
                    <div class="am-panel-hd">
                        <a href="<?php echo $this->createUrl('/mobile/dataMsg/serviceGroupData');?>?service_id=<?php echo $page['service_info']['id'];?>&date=<?php echo ($page['info']['date']-24*60*60);?>&data_type=<?php echo $page['data_type'];?>">
                        ...
                        <?php if ($max_date > $page['info']['date']) {?>
                            <a href="<?php echo $this->createUrl('/mobile/dataMsg/serviceGroupData');?>?service_id=<?php echo $page['service_info']['id'];?>&date=<?php echo ($page['info']['date']+24*60*60);?>" style="float: right;display: inline-block">
        ...
        <div class="am-g">
            <?php foreach ($page['info']['list'] as $value) {?>
                <div class="am-panel am-panel-secondary">
                    <div class="am-panel-hd"><?php echo $value['group_name'];?></div>
                        ...
                        <table class="am-table am-table-centered">
                            ...
                            <?php if ($page['data_type'] == 1) {?>
                                <tr>
                                    ...
                                    <td rowspan="2" class="am-text-middle">
                                        <a href="<?php echo $user_url;?>&group_id=<?php echo $value['group_id'];?>&data_type=1"><span class="am-icon-chevron-right"></span></a>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <?php } else { ?>
                                <tr>
                                    ...
                                    <td rowspan="2" class="am-text-middle"><a href="<?php echo $user_url;?>&group_id=<?php echo $value['group_id'];?>&data_type=2"><span class="am-icon-chevron-right"></span></a></td>
                                </tr>
                                <tr>
