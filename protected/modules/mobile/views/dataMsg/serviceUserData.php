    ...
    <div class="admin-content-body">
        <div class="am-panel-group" id="accordion">
            <div class="am-panel am-panel-secd">
                ...
                <?php $base_url = $this->createUrl('/mobile/dataMsg/serviceUserData').'?service_id='.$page['service_info']['id'].'&group_id='.$page['group_info']['groupid'].'&date='.$page['info']['date'];?>
                <div class="am-panel am-panel-secondary" style="margin-bottom: 10px">
                    <div class="am-panel-hd">
                        <a href="<?php echo $this->createUrl('/mobile/dataMsg/serviceUserData');?>?service_id=<?php echo $page['service_info']['id'];?>&group_id=<?php echo $page['group_info']['groupid'];?>&date=<?php echo ($page['info']['date']-24*60*60);?>">
                        ...
                        <?php if ($max_date > $page['info']['date']) {?>
                            <a href="<?php echo $this->createUrl('/mobile/dataMsg/serviceUserData');?>?service_id=<?php echo $page['service_info']['id'];?>&group_id=<?php echo $page['group_info']['groupid'];?>&date=<?php echo ($page['info']['date']+24*60*60);?>" style="float: right;display: inline-block">
        ...
        <div class="am-g">
            <?php foreach ($page['info']['list'] as $value) {?>
                <div class="am-panel am-panel-secondary">
                    <div class="am-panel-hd"><?php echo $value['user_name'];?>(<?php echo $page['group_info']['groupname'];?>)</div>
