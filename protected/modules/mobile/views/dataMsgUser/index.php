...
<div class="admin-content">
    ...
    <div class="admin-content-body">
            ...
            <div class="am-panel am-panel-secd">
                ...
                <div class="am-panel am-panel-secondary" style="margin-bottom: 10px">
                    <div style="margin-top:50px;text-align: center">
                        <strong class="am-text-default am-text-lg"> &nbsp;推广人员-数据报表
                        </strong>
                    </div>
                    <div class="am-panel-hd">
                        <a href="<?php echo $this->createUrl('/mobile/dataMsgUser/index');?>?tab_id=<?php echo $page['tab_id'];?>&date=<?php echo ($page['info']['date']-24*60*60);?>">
                        ...
                        <?php if ($max_date > $page['info']['date']) {?>
                            <a href="<?php echo $this->createUrl('/mobile/dataMsgUser/index');?>?tab_id=<?php echo $page['tab_id'];?>&date=<?php echo ($page['info']['date']+24*60*60);?>" style="float: right;display: inline-block">
                ...
                <div class="am-g" style="margin: 10px;">
                    ...
                    <form style="width: 97%">
                        <?php if ($page['tab_id'] == 0) : ?>
                            <?php require(dirname(__FILE__) . "/DU_fansTap.php"); ?>
                        <?php elseif ($page['tab_id'] == 1) : ?>
                            <?php require(dirname(__FILE__) . "/DU_outputTap.php"); ?>
                        <?php elseif ($page['tab_id'] == 2) : ?>
                            <?php require(dirname(__FILE__) . "/DU_planTap.php"); ?>
                        <?php endif ?>
                    </form>
                </div >
            </div>
        ...
        <div class="am-g">
            <?php if ($page['tab_id'] == 0) : ?>
                <?php require(dirname(__FILE__) . "/DU_fansTable.php"); ?>
            <?php elseif ($page['tab_id'] == 1) : ?>
                <?php require(dirname(__FILE__) . "/DU_outputTable.php"); ?>
            <?php elseif ($page['tab_id'] == 2) : ?>
                <?php require(dirname(__FILE__) . "/DU_planTable.php"); ?>
            <?php endif ?>
        </div>
...
<script>
    ...
    var url = "<?php echo $this->createUrl('/mobile/dataMsgUser/index');?>";
