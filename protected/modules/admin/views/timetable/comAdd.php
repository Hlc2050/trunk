...
<div class="main mhead">
    <div class="snav">创建普通排期</div>
</div>
<div class="main mbody">
    <div class="add_div ax_default" style="overflow: auto;width:100%">
        <form method="post" action="<?php echo $this->createUrl('timetable/comAdd')?>" onsubmit="return chekFrom()">
            <div style="width: 30%; float: left;padding: 20px 0 20px 20px;text-align:left;font-size:13px" >
                ...
                <div class="form_group">
                    ...
                    <input type="text" size="20" class="ipt" style="width:80px;font-weight: bold;font-size: 12px"
                           id="start_date" name="start_date" value="" onclick="WdatePicker({disabledDays:[1,2,3,4,5,6],minDate:'<?php echo $star_time; ?>',qsEnabled:false,isShowWeek:true,isShowToday:false,firstDayOfWeek:1,dateFmt:'yyyy-MM-dd',
                           onpicked:function() {
            ...
            <div style="width: 65%;float: left;padding: 10px 0 20px 20px;text-align:left;margin: 0" >
                <div style="width:100%">
                    ...
                    <div style="float: left;margin-top: 10px">
                        推广小组：
                        <?php
                        $promotionGrouplist = $this->getUserPromotionGroup('add');
                        ...
                        echo $select_pgid ? CHtml::dropDownList('tg_id', $select_pgid, CHtml::listData(PromotionStaff::model()->getPromotionStaffByPg($select_pgid), 'user_id', 'user_name'), array('empty' => '全部')) :
