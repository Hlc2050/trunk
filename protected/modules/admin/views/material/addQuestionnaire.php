...
<div class="main mhead">
    <div class="snav">素材管理 » 问卷管理 » <?php echo $page['info']['id'] ? '修改问卷' : '添加问卷' ?></div>
</div>
<div class="main mbody">
    <form method="post"
          action="<?php echo $this->createUrl($page['info']['id'] ? 'material/editQuestionnaire' : 'material/addQuestionnaire'); ?>?p=<?php echo $_GET['p']; ?>">
        ...
        <table class="tb3" id="questionnaire">
            ...
            <tr>
                <td >
                    <div class="quest">问题1：<span class="fewer" onclick="showHide(this)">收起</span></div>
