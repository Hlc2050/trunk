...
<div class="main mhead">
    <div class="snav">素材管理 » 评论管理 » <?php echo $page['info']['id'] ? '修改评论' : '添加评论' ?></div>
</div>
    ...
    <form method="post"
        ...
        <table class="tb3" id="questionnaire">
            ...
            <tr>
                <td>评论类型：
                    <?php
                        $reviewTypeList = Linkage::model()->getReviewTypeList();
                        foreach ( $reviewTypeList as $k => $v ){
                    ?>
                    <input type="radio" name="review_type" value="<?php echo $k;?>"><?php echo $v; ?>&nbsp&nbsp&nbsp&nbsp
                    <?php } ?>
                    <span style="color: red">*必填</span>
                </td>
            </tr>
                ...
                <td>头像素材库：
                    <select name="avatar_id">
                        ...
                        foreach ($picGroupList as $key => $val) { ?>
                            <option value="<?php echo $val['id']; ?>" <?php echo $page['info']['avatar_id'] == $val['id'] ? 'selected' : ''; ?>>
            ...
            <tr>
                <td >
                    <div class="review">评论1：<span class="fewer" onclick="showHide(this)">收起</span></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input style="width: 300px;height:30px;font-size: large;" type="text" class="ipt"
                                           name="review_name[]"
                                           value="<?php echo $page['info']['review_name[]'] ? $page['info']['review_name[]'] : ""; ?>"/>
                                    <span style="color: red">*必填</span>
                                </td>
                            </tr>
                            <tr>
                                <td>评论内容</td>
                                <td>
                                    <textarea  style="width: 290px;height:90px;font-size: large;" name="review_content[]"></textarea>
                                    <span style="color: red">*必填</span>
                                </td>
                            </tr>
                            <tr>
