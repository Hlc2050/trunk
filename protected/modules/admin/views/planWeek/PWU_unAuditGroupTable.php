        ...
        <table class="tb" style="width: 900px;margin-top: 10px;margin-bottom: 10px;">
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center">
                    <?php echo $page['manage_group'][$value['group_id']];?>-<?php echo date('Y-m-d',$value['start_date']);?>至<?php echo date('Y-m-d',$value['start_date']+6*24*60*60);?>-排期计划
...
<script type="text/javascript">
    $('input[name="plan_through"]').click(function () {
        if (confirm('确定通过该计划审核？')) {
            ...
            jQuery.ajax({
                'type': 'POST',
                'url': '/admin/planWeek/auditGroupPlan',
