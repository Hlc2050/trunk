<form action="<?php echo $this->createUrl('performanceTable/index'); ?>">
    <label>
        客服部：
        <?php
        ...
        <div class="mt10">
            ...
            <input type="text" size="20" class="ipt"  name="start_date"
                   id="start_date" value="<?php echo $page['first_day']?$page['first_day']:date("Y-m-d", mktime(0, 0, 0, date('m'), 1, date('Y'))); ?>"
