...
<div class="main mhead" xmlns="http://www.w3.org/1999/html">
    <div class="snav">第三方统计 »  域名统计	</div>

    <div class="mt10">
        <form action="<?php echo $this->createUrl('piwikDomain/index'); ?>">日期：
            ...
            域名：
            <input type="text" class="ipt" style="width: 120px;font-size: 15px;" name="domain" value="<?php echo $this->get('domain');?>"  placeholder="域名"/>
            推广人员： <?php
        ...
        <div class="mt10 clearfix">
            <div class="l">
                <?php $this->check_u_menu(array('code'=>'<input type="button" class="but2" value="列表导出" onclick="location=\''.$this->createUrl('piwikDomain/export').'?start_date='.$this->get('start_date').'&end_date='.$this->get('end_date').'&chgId='.$this->get('chgId').'&user_id='.$this->get('user_id').'&search_type='.$this->get('search_type').'&search_txt='.$this->get('search_txt').'\'" />','auth_tag'=>'piwikDomain_export')); ?>
            </div>
            <div class="r">
    ...
    <div class="main mbody">
        <form action="<?php echo $this->createUrl('piwikChannel/saveOrder'); ?>" name="form_order" method="post">
                ...
                foreach($list as $r){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            echo AdminUser::model()->findByPk($r['sno'])->csname_true
                            ?>
                        </td>
            ...
            <div class="pagebar"><?php echo $pagearr['pagecode']; ?></div>
            <div class="clear"></div>
        </form>
    </div>
