...
<table id="exportTable" class="tb fixTh" style="width: 100%">
    ...
    <tbody>
    <?php
    $total_money = $total_uv = $total_fans = $total_estimate_money = $total_estimate_count = $total_fans_count = 0;
    foreach ($page['list'] as $r) {
        ...
        <tr>
            ...
            <td><?php echo round($r['estimate_money'], 2); ?></td>
            <td><?php echo $ROI . "%"; ?></td>
...
<script type="text/javascript">
    $(function () {
        ...
        var html = "<th>合计</th> " +
            ...
            "<th><?php echo $total_ROI . '%';?></th> <th><?php echo $total_fans_count;?></th> <th><?php echo $total_estimate_count;?></th> <th><?php echo $total_fans_cost;?></th> <th><?php echo $total_channel_transform . '%';?></th> " +
