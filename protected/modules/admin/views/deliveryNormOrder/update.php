...
<div class="main mhead">
    <div class="snav">订单系统 » 订单发货 » 修改发货信息</div>
</div>
<div class="main mbody">
    <form method="post"
          action="<?php echo $this->createUrl('deliveryNormOrder/edit'); ?>?id=<?php echo $page['info']['id']; ?>">
            ...
            <tr>
                ...
                <td>
                    <select name="delivery_status">
                        <option value="1" <?php echo $page['info']['delivery_status'] == 1 ? 'selected' : ''; ?>>已发货
                        </option>
                        <option value="2" <?php echo $page['info']['delivery_status'] == 2 ? 'selected' : ''; ?>>撤单
                        </option>
                    </select>
                </td>
            </tr>
