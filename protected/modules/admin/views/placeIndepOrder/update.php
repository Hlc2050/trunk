...
<div class="main mhead">
    <div class="snav">订单系统 » 独立订单下单 » 修改下单信息</div>
</div>
<div class="main mbody">
    <form method="post"
          action="<?php echo $this->createUrl('placeIndepOrder/edit'); ?>?id=<?php echo $page['info']['id']; ?>">
        ...
        <table class="tb3">
            ...
            <tr>
                <td>单量：</td>
                <td>
                    <input type="text" class="ipt" name="order_count"
                           value="<?php echo $page['info']['order_count']; ?>"/>
                </td>
            </tr>
            <tr>
                <td>下单金额：</td>
