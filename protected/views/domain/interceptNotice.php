...
<h3>一共<?php echo $page['intercepts']; ?>个域名被拦截</h3>
...
//            $new_url = $info->domain;
        ...
        <li>
            <span>应用类型:</span>
            <?php $application_type = $r['application_type'] == 1?'静态应用':'普通应用'; ?>
            <span><?php echo $application_type; ?></span>
        </li>
        <li>
            ...
            ?>
            <a href="<?php echo $old_url; ?>" style="color: red"><?php echo $old_url.$old_public_domain; ?></a>
        </li>
        <li>
        ...
        <li >
            ...
            <?php if ($r['promotion_id'] == 0) {
                echo '-'; ?>
            <?php } else { ?>
                <a class="new_url" href="<?php echo $href; ?>"><?php echo $href.$new_public_domain; ?></a>
            <?php } ?>
        </li>
        <li>
        ...
        <?php  if($r['is_replace'] == 1) { ?>
            <li  <?php if($r['domain_type']==0 || $r['promotion_id']==0){?> style="border-bottom: 1px solid #e7e7eb;"<?php }?>>
                ...
                <?php echo date('Y-m-d H:i:d',$r['upd_time']); ?>
            </li>
        <?php }  ?>
